...
const ERRORS: Record<string, string> = {
  google_off: "Google sign-in isn't set up yet. Use your email instead.",
  ...
  db: "We couldn't reach the database just now. Please try again shortly.",
...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ next?: string; error?: string }> }) {
  ...
  const error = sp.error ? ERRORS[sp.error] || "Something went wrong. Please try again." : "";
  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        {googleConfigured ? (
          <>
            <a className="g-btn" href={googleHref}>
